      ...
      <Accordion as="ul" className="navbar-nav iq-main-menu" id="sidebar-menu">
        ...
        >
          ...
          >
            ...
            <span className="item-name">Area de Escolas</span>
          ...
          <Accordion.Collapse eventKey="area-escola">
        ...
        >
          ...
          >
            ...
            <span className="item-name">Area de Categoria</span>
            <i className="right-icon">
              <svg
                className="icon-18"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <ul className="sub-nav">
              <Nav.Item as="li">
                ...
                >
                  ...
                  <OverlayTrigger
                    placement="right"
                    overlay={<Tooltip>Adicionar Disciplina</Tooltip>}
                  >
                    <i className="sidenav-mini-icon"> A </i>
                  </OverlayTrigger>
        ...
        >
          ...
          >
            ...
            <span className="item-name">Area de Província</span>
            <i className="right-icon">
              <svg
                className="icon-18"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <ul className="sub-nav">
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  <span className="item-name">Listar Províncias</span>
                </Link>
              </Nav.Item>
            </ul>
          </Accordion.Collapse>
        ...
        >
          ...
          >
            ...
            <span className="item-name">Area de Município</span>
            <i className="right-icon">
              <svg
                className="icon-18"
                xmlns="http://www.w3.org/2000/svg"
          ...
          <Accordion.Collapse eventKey="municipio">
            <ul className="sub-nav">
              <Nav.Item as="li">
                <Link
                  className={`${
                ...
                >
                  ...
                  <OverlayTrigger
                    placement="right"
                    overlay={<Tooltip>Adicionar Município</Tooltip>}
                  >
                    <i className="sidenav-mini-icon"> A </i>
                  </OverlayTrigger>
                  <span className="item-name">Adicionar Município</span>
                </Link>
              </Nav.Item>
              <Nav.Item as="li">
                <Link
                ...
                >
                  ...
                  <OverlayTrigger
                    placement="right"
                    overlay={<Tooltip>Listar Município</Tooltip>}
                  >
                    <i className="sidenav-mini-icon"> U </i>
                  </OverlayTrigger>
                  <span className="item-name">Listar Município</span>
                </Link>
              </Nav.Item>
            </ul>
          </Accordion.Collapse>
        ...
        >
          ...
          >
            ...
            <span className="item-name">Area de Actividade</span>
            <i className="right-icon">
              <svg
                className="icon-18"
                xmlns="http://www.w3.org/2000/svg"
          ...
          <Accordion.Collapse eventKey="area-actividade">
            <ul className="sub-nav">
              <Nav.Item as="li">
                <Link
                  className={`${
              ...
              <Nav.Item as="li">
                ...
                >
                  ...
                  <span className="item-name">Listar Actividade</span>
                </Link>
              </Nav.Item>
            </ul>
          </Accordion.Collapse>
