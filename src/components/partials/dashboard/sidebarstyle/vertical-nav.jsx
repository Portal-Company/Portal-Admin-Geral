      ...
      <Accordion as="ul" className="navbar-nav iq-main-menu" id="sidebar-menu">
        ...
        >
          ...
          >
            ...
            <span className="item-name">Província</span>
            <i className="right-icon">
              <svg
                className="icon-18"
                xmlns="http://www.w3.org/2000/svg"
          ...
          <Accordion.Collapse eventKey="area-provincia1">
            <ul className="sub-nav">
              <Nav.Item as="li">
                <Link
                  className={`${
                    location.pathname === "/provincia/provincia-add"
                      ? "active"
                      : ""
                  } nav-link`}
                  to="/provincia/provincia-add"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
                  ...
                  <span className="item-name">Adicionar Provincia</span>
                </Link>
              </Nav.Item>
              <Nav.Item as="li">
                <Link
                  className={`${
                    location.pathname === "/provincia/provincia-list"
                      ? "active"
                      : ""
                  } nav-link`}
                  to="/provincia/provincia-list"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
                  ...
                  <span className="item-name">Listar Provincia</span>
                </Link>
              </Nav.Item>
            </ul>
          </Accordion.Collapse>
        ...
        <Accordion.Item
          as="li"
          eventKey="area-disciplina4"
          bsPrefix={`nav-item ${active === "pulgins" ? "active" : ""} `}
          onClick={() => setActive("pulgins")}
        >
          <CustomToggle
            eventKey="area-provincia4"
            active={activeMenu === "plugins" ? true : false}
            onClick={(activeKey) => setActiveMenu(activeKey)}
          >
            <OverlayTrigger
            ...
            <span className="item-name">Municipio</span>
            <i className="right-icon">
              <svg
                className="icon-18"
                xmlns="http://www.w3.org/2000/svg"
          ...
          <Accordion.Collapse eventKey="area-provincia4">
            <ul className="sub-nav">
              <Nav.Item as="li">
                <Link
                  className={`${
                    location.pathname === "/municipio/municipio-add"
                      ? "active"
                      : ""
                  } nav-link`}
                  to="/municipio/municipio-add"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
                  ...
                  <OverlayTrigger
                    placement="right"
                    overlay={<Tooltip>Adicionar Municipio</Tooltip>}
                  >
                    <i className="sidenav-mini-icon"> A </i>
                  </OverlayTrigger>
                  <span className="item-name">Adicionar Municipio</span>
                </Link>
              </Nav.Item>
              <Nav.Item as="li">
                <Link
                  className={`${
                    location.pathname === "/municipio/municipio-list"
                      ? "active"
                      : ""
                  } nav-link`}
                  to="/municipio/municipio-list"
                >
                  <i className="icon">
                    <svg
                      className="icon-10"
                  ...
                  <OverlayTrigger
                    placement="right"
                    overlay={<Tooltip>Listar Municipio</Tooltip>}
                  >
                    <i className="sidenav-mini-icon"> U </i>
                  </OverlayTrigger>
                  <span className="item-name">Listar Municipio</span>
                </Link>
              </Nav.Item>
            </ul>
          </Accordion.Collapse>
